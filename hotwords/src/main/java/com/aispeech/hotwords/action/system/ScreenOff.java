...
public class ScreenOff implements IAction {
    ...
    @Override
    public void execute() {
        LogUtils.d("execute ScreenOff");
        PowerManager powerManager = (PowerManager) App.getApp().getSystemService(Context.POWER_SERVICE);
        PowerManager.WakeLock wakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "ScreenOff");
        wakeLock.release();
    }
}
